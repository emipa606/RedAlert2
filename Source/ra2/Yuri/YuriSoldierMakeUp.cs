...
namespace ra2.Yuri
{
    public static class YuriSoldierMakeUp
    {
        ...
        public static void controlOtherFactionGoodWill(Pawn user, Pawn target)
        {
            ...
            faction.TryAffectGoodwillWith(faction2, goodwillImpact, true, true, null, lookTarget);
            faction.Notify_GoodwillSituationsChanged(faction2, true, reason, lookTarget);
        }
    }
}